...
class camera 
{
    ...
    private:
        ...
        void initialize()
        {
            ...
            // u, v, w unit basis vectors for the camera coordinate fram
            w = unit_vector(lookfrom - lookat);
            u = unit_vector(cross(vup, w));
            v = cross(w, u);

            // Vectors going across the horizontal and downthe vertical viewport edges
        ...
        {
            // Construct a camera ray originaing from the defocus disk and directed at a 
