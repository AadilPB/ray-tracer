...
class sphere : public hittable
{
    public:
        ...
        private:
            ...
            {
                // p: a point of the sphere of radius one, centered at the origin.
                // u: a returned value in [0, 1] of the angle around the Y axis from X = -1
                // v: a returned value in [0, 1] of the angle from Y = -1 to y = +1
