...
void earth()
{
    ...
    renderer render(cam, hittable_list(globe), 11);
...
void simple_light()
{
    ...
    world.add(make_shared<sphere>(point3(-20,5,0), 2, difflight));
    world.add(make_shared<sphere>(point3(7, 2, 7), 2, difflight));
...
void cornell_box()
{
    ...
    auto red   = make_shared<lambertian>(color(.65, .05, .06));
...
void final_scene(int image_width, int samples_per_pixel, int max_depth)
{
    ...
    auto light = make_shared<diffuse_light>(color(7, 7, 7));
    world.add(make_shared<quad>(point3(123, 553, 147), vec3(300, 0, 0), vec3(0, 0, 265), light));
